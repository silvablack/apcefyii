...
//              $meio_pagamento     	= $transacao_dados->transacao->meio_pagamento;
	...
	public function createTransaction() {
		...
		// if ($numero_metodo_pagamento) {
			...
			$json_pedido['shippingAddressState']      = $st_comprador->virtuemart_state_id2;
			//$json_pedido['shippingAddressState']      = $this->getStateName($st_comprador->virtuemart_state_id); pega estado apartir de uma lista e do novo campo criado por mim stat_id2. comentado por rodrigo hilario cdl
			...
			$json_pedido['billingAddressState']     = $bt_comprador->virtuemart_state_id2;
			//$json_pedido['billingAddressState']     = $this->getStateName($bt_comprador->virtuemart_state_id); pega estado apartir de uma lista e do novo campo criado por mim stat_id2. comentado por rodrigo hilario cdl
