  		...
  		<div class="container">
  			<div class="nav-holder">
  				<div class="maga-drop-wrap">
  					...
  					<!-- Logo -->
  					<div class="logo">
  						<a href="#"><img src="images/logo-apcef.png" style="margin-left: 5px;" alt=""></a>
  					</div>
  					<!-- Logo -->
  					...
  					<ul class="nav-list pull-right">
  						<li>
  								...
  								<ul>
  									<li><a href="paginas/tb_atestadoPendente.php">Atestado Pendentes</a></li>
  									<li><a href="paginas/tb_atestadook.php">Atestado OK</a></li>
  									<li><a href="paginas/representantes.php">Representantes</a></li>
  								</ul>
  						</li>
  						...
  						<li>
  								<a href="#">Campeonato</a>
  								<ul>
  									<li><a href="../../../paginas/ficha.pdf">Formulário</a></li>
  									<li><a href="paginas/futsal_2012.php">Futsal 2012</a></li>
  									<li><a href="paginas/futsal_2013.php">Futsal 2013</a></li>
  									<li><a href="paginas/futsal_2014.php">Futsal 2014</a></li>
  									<li><a href="paginas/futsal_2015.php">Futsal 2015</a></li>
  									<li><a href="paginas/society_2011.php">Society 2011</a></li>
  									<li><a href="paginas/society_2012.php">Society 2012</a></li>
  									<li><a href="paginas/society_2013.php">Society 2013</a></li>
  									<li><a href="paginas/society_2014.php">Society 2014</a></li>
  									<li><a href="paginas/society_2015.php">Society 2015</a></li>
  								</ul>
  						</li>
  						<li>
  								<a href="#">Tabelas</a>
  								<ul>
  									<li><a href="/paginas/tabela_geral_livre_rodada1.php">Livre-série Ouro</a></li>
  									<li><a href="/paginas/tabela_geral_livre_rodada1p.php">Livre-série Prata</a></li>
  									<li><a href="/paginas/tabela_geral_livre_rodada1q.php">Quarentão</a></li>
  									<li><a href="/paginas/tabela_geral_livre_rodada1c.php">Cinquentão</a></li>
  								</ul>
  						</li>
  						<li>
  								<a href="#">Disciplina</a>
  								<ul>
  									<li><a href="/paginas/tabela_julgamento.php">Resultado Julgamento</a></li>
  									<li><a href="/paginas/tabela_pendurados.php">Atleta Pendurado</a></li>
  									<li><a href="/paginas/tabela_suspensos.php">Atleta Suspenso</a></li>
  								</ul>
  						</li>
  						<li>
  								<a href="#">Scouts</a>
  								<ul>
  									<li><a href="/paginas/classificacaoprincipal.php">Livre</a></li>
  									<li><a href="/paginas/classificacaoquarentao.php">Quarentão</a></li>
  									<li><a href="/paginas/classificacaocinquentao.php">Cinquentão</a></li>
  								</ul>
  						</li>
  						<li><a href="#">Regulamento</a>
  							<ul>
  								<li><a href="../../../paginas/RGC.pdf">RGC</a></li>
  								<li><a href="../../../paginas/disputafutsal.pdf">Anexo-1 Futsal</a></li>
  								<li><a href="../../../paginas/disputasociety2016.pdf">Anexo-2 Society</a></li>
  								<li><a href="paginas/cde.pdf">CDE</a></li>
  								<li><a href="../../../paginas/tbgeral.pdf">Tabela Geral</a></li>
  							</ul>
  						</li>
  				...
  				<div class="inner-banner-2">
  					<div class="carousel-inner" role="listbox">
  							...
  							<div class="item active">
  								<img class="fullscreen" src="images/futebol-image1.jpg" alt="">
  				...
  				<div class="row">
  					...
  					<div class="col-lg-3 col-xs-6 r-full-width">
  						<div class="column-widget h-white">
  							...
  							<!-- Form -->
  							<form id="contact-form" class="contact-form col-sm-6" action="paginas/enquete.php" method="get" onsubmit="return validaForm()" target="voto">
